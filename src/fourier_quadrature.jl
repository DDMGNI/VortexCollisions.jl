...
function fourier_quadrature(w::Matrix{CT}, v::Union{Array{CT, 2}, SharedArray{CT, 2}},
        u::Union{Array{CT, 2}, SharedArray{CT, 2}},
...
function fourier_quadrature(
        w::Matrix{Matrix{CT}}, v::Union{Array{CT, 2}, SharedArray{CT, 2}},
        u::Union{Array{CT, 2}, SharedArray{CT, 2}},
        grid::Grid2d{M, N, RT}) where {M, N, RT, CT}
...
function fourier_quadrature(
        w::Matrix{Matrix{CT}}, v::Union{Vector{Array{CT, 2}}, Vector{SharedArray{CT, 2}}},
        u::Union{Array{CT, 2}, SharedArray{CT, 2}},
        grid::Grid2d{M, N, RT}) where {M, N, RT, CT}
